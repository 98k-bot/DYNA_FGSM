...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH -p gpu,preemptable
#SBATCH --gpus=a100:2
#SBATCH --job-name=FGSM_ESM2_zhanh
#SBATCH -t 148:00:00
#SBATCH --mem=256000MB
#SBATCH --mail-type=FAIL,BEGIN,END
#SBATCH --mail-user=huixin.zhan@cshs.org
#SBATCH -o /common/zhangz2lab/zhanh/Jupyter_Scripts/out_FGSM
#SBATCH -e /common/zhangz2lab/zhanh/Jupyter_Scripts/err_FGSM
source /common/zhanh/anaconda3/etc/profile.d/conda.sh
conda activate dna_gpn
/common/zhanh/anaconda3/envs/dna_gpn/bin/python

python VEP_ESM_PLLR_FGSM_layer.py
#data_path=$1
#lr=3e-5
...
#    do
#        python DNA_llm_test_domain_350m.py \
...
#            --fp16 \
#            --save_steps 200 \
#            --output_dir output/opt_350m_domain \
